    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                DatabaseReference classref = FirebaseDatabase.getInstance().getReference().child("Exam").child(classs);
                classref.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot1) {
                        ...
                        adapter = new DataAdapter(ExamActivity.this,UploadList);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ExamActivity.this, WebActivity.class);
